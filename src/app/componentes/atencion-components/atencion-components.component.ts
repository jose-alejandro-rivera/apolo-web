...
@Component({
  ...
  providers: [AppGlobals, Integracion, IntegracionCamaraComponent, IntegracionHadaComponent]
})
/**
...
export class AtencionComponentsComponent implements OnInit {
  ...
  public integracionhada: boolean = false;
  public certificacionRealizada: string;
  ...
  //public regPasoAnterior : any;
  public RACodPaso: any;
  ...
  constructor(
    ...
    private integracionHadaComponent: IntegracionHadaComponent
  ) {
...
**/
  async validarAcceso() {
    ...
    if (this.dataFlujoOrden.retomaOrden) {
      ...
      this.solocobre = this.dataFlujoCat.NomFlujo;
      //this.integracionHada(actividad:string)
      //console.log('this.actividadhada validarAcceso --->', this.solocobre);
      this.listFlujo();
    }
  }
  ...
  listFlujo() {
    ...
    return this.atencionService.getData(this.url).toPromise().then(data => {
      ...
      if (data.Cuestionarios.find(x => x.Id_Paso == this.pasoActual)) {
        ...
        this.actividadhada = this.procesoPaso.Descripcion;
        this.integracionHada(this.actividadhada);
  ...
  listRetoma() {
    ...
    return this.atencionService.getData(url).toPromise().then(data => {
      ...
      this.dataFlujoOrden = JSON.parse(localStorage.getItem('dataFlujoOrden'));
      this.orden = this.dataFlujoOrden.formOrden.orden;
      // this.global.usuarioView = this.dataFlujoOrden.name;
  ...
  */
  ...
  Atras(Id_Paso: any) {
    ...
    this.atencionService.getData(url).toPromise().then((data: IRecordResponse) => {
      ...
      // this.regPasoAnterior = this.mapaTrazabilidad.find(x => x.Id_AtencionPaso == max);

      /*
       let CodPasOrigen = this.info.FlujoPasos.find((x) => {
         return parseInt(x.CodPaso_Destino) == parseInt(Id_Paso)
       }); */

      /*
       this.RACodPaso = newArray.find((f) => {
  ...
  */
  ...
  /**
   * Component IntegracionHadaComponent
   * 
   */
